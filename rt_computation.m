...
%     y2=[193 185 68 71 108 133];
    ...
    %values for lab1
%     x1=[283 281 284 87 391 76];
%     y1=[36 99 173 73 220 47];
%     x2=[523 503 548 335 629 327];
%     y2=[155 213 291 199 336 179];

    %values for lab2
    x1=[197 240 228 246 196 172];
    y1=[18 19 87 120 161 372];
    x2=[559 607 570 585 576 609];
    y2=[36 31 101 131 183 403];
